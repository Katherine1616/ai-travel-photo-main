...
> 设计一个商场门店 AI 虚拟试衣大屏原型，不上传真人照片；保留快速匹配和手机精细定制两种匿名人物入口；重点展示生成等待、失败、隐私和从试穿到购买的转化路径。
...
- [codebuddy-aifit-demo](https://github.com/yihui-dev/codebuddy-aifit-demo)：参考微信生态中的选款与试穿入口；本项目改为门店大屏加手机承接。
...
在原有旅拍/试衣项目上重新定义门店大屏信息架构；整理六款门店商品与模拟库存；设计两类匿名人物入口及九种离散画像；实现生成进度、失败、超时、45 秒清除、二维码手机结果、尺码与四类履约路径；压缩图标依赖并完成桌面/移动端验证。产品判断、流程边界、隐私规则、文案和最终交互均由本人审阅调整。
